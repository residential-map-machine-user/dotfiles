...
export ECLIPSE_HOME
PATH=$HOME/android-ndk-r10e:$HOME/Library/Android/sdk/platform-tools:$HOME/Library/Android/sdk/tools:$GRADLE_HOME/bin:$HOME/.nodebrew/current/bin:/usr/local/bin:/Users/yukimatsuyama/.mongodb/bin:$PATH
export PATH
